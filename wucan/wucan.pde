...
void setup(){
    ...
    text("一楼快餐厅", chart_x+0*w+w/2, chart_y+tick_padding);
    text("二楼快餐厅", chart_x+1*w+w/2, chart_y+tick_padding);
    text("二楼面馆", chart_x+2*w+w/2, chart_y+tick_padding);
    text("第五餐饮教育超市", chart_x+3*w+w/2, chart_y+tick_padding);
    text("中西餐厅", chart_x+4*w+w/2, chart_y+tick_padding);//x axis text 
