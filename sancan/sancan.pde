...
void setup(){
    ...
    text("北区教育超市", chart_x+0*w+w/2, chart_y+tick_padding);
    text("外婆桥", chart_x+1*w+w/2, chart_y+tick_padding);
    text("清真餐厅", chart_x+2*w+w/2, chart_y+tick_padding);
    text("学生餐厅", chart_x+3*w+w/2, chart_y+tick_padding);
    text("时光咖啡", chart_x+4*w+w/2, chart_y+tick_padding);//x axis text 
